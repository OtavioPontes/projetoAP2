...
public class CadastroEnderecoGUI {
	...
	private Endereço enderecoFinal;
	...
	public CadastroEnderecoGUI() {
		...
		frameCadastroEndereco.setVisible(true);
	}
	...
	private void criaLayout() {
		...
		buttonCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				tipoDeLogradouro = textFieldTipoDeLogradouro.getText();
				estado = UfEstado(choiceUF.getSelectedItem());
				
				if(checkBoxTipe.isSelected() == true) {
					tipe = "Residencial";
				} else {
					tipe = "Outro";
				}
				...
				try {
					...
					enderecoFinal = new Endereço(tipe, tipoDeLogradouro, logradouro, numero, bairro, cidade, estado, cep);
					textFieldBairro.setText("");
					textFieldCep.setText("");
					textFieldCidade.setText("");
					textFieldLogradouro.setText("");
					textFieldNumero.setText("");
					textFieldTipoDeLogradouro.setText("");
					
					frameCadastroEndereco.setVisible(false);
					
				}catch (NumberFormatException e1) {
					JOptionPane.showMessageDialog(null, "Entrada de numero invalida.");
				}
	...
	//Retorna o endereço para outra janela
	public Endereço getEnderecoFinal() {
